...
const ProductTypeView = (props) => {
  return (
    <Container fluid>
      ...
      <div className="product__type-view__button-row">
        <Button
          title="Editar"
          aria-label="Editar"
          className="product__type-form__button"
          color="primary"
          onClick={() =>
        ...
        >
          <svg
            ...
            stroke-width="0"
            viewBox="0 0 576 512"
            class="product-list__button-icon"
            height="1em"
            width="1em"
        ...
        <Button
          title="Volver"
          aria-label="Volver"
          className="product__type-form__button btn-outline-secondary"
          color="default"
