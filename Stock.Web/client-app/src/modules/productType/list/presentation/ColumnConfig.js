...
const renderToolbar = ({ value }) => {
  let viewButton = (
    <Link
      className="product__type-list__button"
      to={`/productType/view/${value}`}
    >
      <FaSearch className="product__type-list__button-icon" />
    </Link>
  );
  ...
  let editButton = (
    ...
    >
      <FaEdit className="product__type-list__button-icon" />
    </Link>
  );
  ...
  let removeButton = (
    ...
    >
      <FaTrash className="product__type-list__button-icon" />
    </Link>
  );
