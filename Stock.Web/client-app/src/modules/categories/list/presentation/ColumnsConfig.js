...
const renderToolbar = ({ value }) => {
  let viewButton = (
    <Link className="category-list__button" to={`/producttype/view/${value}`}>
      <FaSearch className="category-list__button-icon" />
    </Link>
  );

  let editButton = (
    <Link className="category-list__button" to={`/producttype/update/${value}`}>
      <FaEdit className="category-list__button-icon" />
    </Link>
  );

  let removeButton = (
    <Link className="category-list__button" to={`/producttype/remove/${value}`}>
