...
const renderToolbar = ({ value }) => {
  let viewButton = (
    <Link className="productType-list__button" to={`/product-type/view/${value}`}>
      <FaSearch className="productType-list__button-icon" />
    </Link>
  );

  let editButton = (
    <Link className="productType-list__button" to={`/product-type/update/${value}`}>
      <FaEdit className="productType-list__button-icon" />
    </Link>
  );

  let removeButton = (
    <Link className="productType-list__button" to={`/product-type/remove/${value}`}>
